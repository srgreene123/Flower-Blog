...
class LocationResourceIT {
    ...
    public static Location createEntity(EntityManager em) {
        Location location = new Location().city(DEFAULT_CITY).countryName(DEFAULT_COUNTRY_NAME);
        return location;
    }
    ...
    public static Location createUpdatedEntity(EntityManager em) {
        Location location = new Location().city(UPDATED_CITY).countryName(UPDATED_COUNTRY_NAME);
        return location;
    }
    ...
    void putExistingLocation() throws Exception {
        ...
        updatedLocation.city(UPDATED_CITY).countryName(UPDATED_COUNTRY_NAME);
    ...
    void fullUpdateLocationWithPatch() throws Exception {
        ...
        partialUpdatedLocation.city(UPDATED_CITY).countryName(UPDATED_COUNTRY_NAME);
