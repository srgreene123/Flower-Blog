...
class PostResourceIT {
    ...
    public static Post createEntity(EntityManager em) {
        Post post = new Post().name(DEFAULT_NAME).date(DEFAULT_DATE);
        return post;
    }
    ...
    public static Post createUpdatedEntity(EntityManager em) {
        Post post = new Post().name(UPDATED_NAME).date(UPDATED_DATE);
        return post;
    }
    ...
    void putExistingPost() throws Exception {
        ...
        updatedPost.name(UPDATED_NAME).date(UPDATED_DATE);
    ...
    void fullUpdatePostWithPatch() throws Exception {
        ...
        partialUpdatedPost.name(UPDATED_NAME).date(UPDATED_DATE);
