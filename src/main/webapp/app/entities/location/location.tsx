  ...
  return (
    <div>
      <h2 id="location-heading" data-cy="LocationHeading">
        <Translate contentKey="blogApp.location.home.title">Locations</Translate>
        <div className="d-flex justify-content-end">
          <Button className="me-2" color="info" onClick={handleSyncList} disabled={loading}>
            <FontAwesomeIcon icon="sync" spin={loading} />{' '}
            <Translate contentKey="blogApp.location.home.refreshListLabel">Refresh List</Translate>
          </Button>
          <Link to="/location/new" className="btn btn-primary jh-create-entity" id="jh-create-entity" data-cy="entityCreateButton">
            <FontAwesomeIcon icon="plus" />
            &nbsp;
            <Translate contentKey="blogApp.location.home.createLabel">Create new Location</Translate>
          </Link>
        </div>
      </h2>
        ...
        {locationList && locationList.length > 0 ? (
          <Table responsive>
            <thead>
              <tr>
                <th>
                  <Translate contentKey="blogApp.location.id">ID</Translate>
                </th>
                <th>
                  <Translate contentKey="blogApp.location.city">City</Translate>
                </th>
                <th>
                  <Translate contentKey="blogApp.location.countryName">Country Name</Translate>
                </th>
                <th />
              </tr>
            </thead>
          ...
          !loading && (
            <div className="alert alert-warning">
              <Translate contentKey="blogApp.location.home.notFound">No Locations found</Translate>
            </div>
          )
        )}
      </div>
