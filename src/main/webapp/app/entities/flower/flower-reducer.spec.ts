...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './flower.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_FLOWER_LIST actions', async () => {
    ...
    it('dispatches FETCH_FLOWER actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_FLOWER actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_FLOWER actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_FLOWER actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_FLOWER actions', async () => {
      const expectedActions = [
        {
