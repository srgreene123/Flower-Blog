...
export const PostUpdate = () => {
  ...
  const flowers = useAppSelector<IFlower[]>(state => state.flower.entities);
        ...
        <Col md="8">
          {loading ? (
            ...
            <ValidatedForm defaultValues={defaultValues()} onSubmit={saveEntity}>
              ...
              <ValidatedField label={translate('blogApp.post.name')} id="post-name" name="name" data-cy="name" type="text" />
              <ValidatedField label={translate('blogApp.post.date')} id="post-date" name="date" data-cy="date" type="text" />
              <ValidatedField id="post-user" name="user" data-cy="user" label={translate('blogApp.post.user')} type="select">
                <option value="" key="0" />
                {users
